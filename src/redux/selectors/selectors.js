...
export const tankSel = (state) => state.orderTable.isFullTank;
export const chairSel = (state) => state.orderTable.isNeedChildChair;
export const wheelSel = (state) => state.orderTable.isRightWheel;
